...
begin
  ...
  begin
    ...
    SpTBXLabel21.Caption:= FloatToStrF(f3,fffixed,10,0) + ' р' + ' (' + IntToStr(Round(count_days)) + ' дней)';
    SpTBXLabel44.Caption:= FloatToStrF(f3-f5,fffixed,10,0) + ' р';
    if max_dist > 0 then
      SpTBXLabel85.Caption:= FloatToStrF((f3)/max_dist,fffixed,10,1) + ' р/км'
    else
  ...
  begin
    ...
    SpTBXLabel32.Caption:= FloatToStrF(f3,fffixed,10,0) + ' р' + ' (' + IntToStr(Round(count_days)) + ' дней)';
    SpTBXLabel46.Caption:= FloatToStrF(f3-f5,fffixed,10,0) + ' р';
    if max_dist > 0 then
      SpTBXLabel84.Caption:= FloatToStrF((f3)/max_dist,fffixed,10,1) + ' р/км'
    else
...
begin
  ...
  if aClass.FindPropertyByName('DistI').ValueI > 0 then
    Memo13.Text:= IntToStr(aClass.FindPropertyByName('DistI').ValueI) + ' км'
  else
    Memo13.Text:= '--';
  s:= '';
  for n:= 1 to 2 do
